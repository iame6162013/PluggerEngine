...
public class StaticShader extends ShaderProgram{
	...
	private static final String VERTEX_FILE = "src/plugger/shaders/vertexShader.txt";
	private static final String FRAGMENT_FILE = "src/plugger/shaders/fragmentShader.txt";
